...
mkdir -p ${__DIR__}/tmp
wget -qqO - "https://www.apache.org/dyn/mirrors/mirrors.cgi?action=download&filename=zookeeper/zookeeper-${__ZK_VERSION__}/apache-zookeeper-${__ZK_VERSION__}-bin.tar.gz" \
